...
def desenhar_quadrado(fill_color: str, lado:int):
    ...
    rand_x = random.randint(0, 300 - lado)                                                                  
...
def desenhar_octogono(fill_color: str, lado:int):
    ...
    rand_y = random.randint(-300, -altura)
...
def desenhar_trapezio(fill_color: str, lado_menor:int, lado_maior:int, lado_nao_paralelo:int):
    ...
    angulo_rad = math.radians(50)                                                                      
    altura = int(lado_nao_paralelo * math.sin(angulo_rad))                                             
                                                                                                     
    rand_x = random.randint(-300, -lado_maior)                                     
    rand_y = random.randint(altura, 300)           
